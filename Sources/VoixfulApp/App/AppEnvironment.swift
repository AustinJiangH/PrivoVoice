...
final class AppEnvironment {
    ...
    /// Locate the `VoixfulEngineHelper` sidecar: an env override (dev), else a
    ...
    private static func resolveHelperURL() -> URL {
        if let override = ProcessInfo.processInfo.environment["VOIXFUL_HELPER_PATH"] {
        ...
        return dir.appendingPathComponent("VoixfulEngineHelper")
    }
}
